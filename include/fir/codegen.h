...
/// Enumeration containing the types of available target machines.
...
/// Creates a code generator from the given options specified as character strings.
/// Available options depend on the target machine type.
